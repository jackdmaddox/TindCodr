...
insert into projects
    (project_title, project_start, project_summary, project_url, project_open, project_users_id)
VALUES
    ('tindcodr', 'friday', 'group project 2 to take over the world!', 'bigurl here', 'Open', 2);

insert into projects
    (project_title, project_start, project_summary, project_url, project_open, project_users_id)
VALUES
    ('tindcodr', 'friday', 'group project 2 to take over the world!', 'bigurl here', 'Open', 3);

insert into projects
    (project_title, project_start, project_summary, project_url, project_open, project_users_id)
VALUES
    ('tindcodr', 'friday', 'group project 2 to take over the world!', 'bigurl here', 'Open', 4);

insert into projects
    (project_title, project_start, project_summary, project_url, project_open, project_users_id)
VALUES
    ('tindcodr', 'friday', 'group project 2 to take over the world!', 'bigurl here', 'Open', 5);
